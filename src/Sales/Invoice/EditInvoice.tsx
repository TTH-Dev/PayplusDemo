...
const EditInvoice = () => {
  ...
  const hanldeSave = async () => {
    ...
    try {
      ...
      navigate(`/sales/invoice/invoice-receipt/${res.data.data.invoice._id}`);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  useEffect(() => {
    const storedData = sessionStorage.getItem("editInvoiceData");
    ...
    if (storedData) {
      ...
      setInvoiceData(
        parsedData.services.map((service: any, index: number) => ({
          ...
          additionalCharges: parsedData.anyCharges || 0,
        }))
      );
  
      setAdditionalData({
        discount: parsedData.discount || 0,
        anyCharges: parsedData.anyCharges || 0,
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell style={cellStyle}>
                  ...
                  />
                  {/* {additionalData.discountType==="rupees"?"₹":"%"} */}
                </TableCell>
                {/* <TableCell style={cellStyle}>
  <Select
