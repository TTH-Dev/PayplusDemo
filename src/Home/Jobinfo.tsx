...
const Jobinfo = ({
  ...
  const handleNext = () => {
    ...
    formData.append("dailyWorkHr", jobInfoData.dailyWorkHr.toString());
    formData.append("overtimePerHr", jobInfoData.overtimePerHr.toString());
  
   // need to remove required true in backend
  ...
  className="input-dd"
                  ...
                  onChange={(value) => setJobinforData({ ...jobInfoData, jobCategory: value })}
                /> */}
              ...
              >
                DailyworkHrs <span style={{color:"red"}}>*</span>
              </label>
              <br />
              <InputNumber
                className="input-dd"
                value={jobInfoData.dailyWorkHr}
                onChange={(value) =>
                  setJobinforData({
                    ...jobInfoData,
                    dailyWorkHr: value || 0,
